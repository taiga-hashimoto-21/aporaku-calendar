...
export default function PrivacyPage() {
  return (
    <LegalPageShell title="プライバシーポリシー">
      <p>
        {COMPANY_NAME}
        （以下「当社」といいます）は、本ウェブサイト上で提供するサービス「
        {SERVICE_NAME}
      ...
      <LegalSection title="第2条（個人情報を収集・利用する目的）">
      ...
      <LegalSection title="第6条（個人情報の第三者提供）">
        <p>
        ...
        <ol className="list-decimal pl-5 space-y-1" start={1}>
          <li>
      ...
      <LegalSection title="第7条（個人情報の開示）">
        <p>
      ...
      <LegalSection title="第8条（個人情報の訂正および削除）">
        <p>
      ...
      <LegalSection title="第9条（個人情報の利用停止等）">
        <p>
      ...
      <LegalSection title="第10条（継続的改善）">
        <p>
          当社は、個人情報の取り扱いに関する運用状況を適宜見直し、継続的な改善に努めるものとし、必要に応じて、プライバシーポリシーを変更することがあります。本ポリシーの内容は、法令その他本ポリシーに別段の定めのある事項を除いて、ユーザーに通知することなく変更することができるものとします。
